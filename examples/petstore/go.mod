...
require (
	github.com/pablor21/gonnotation v0.0.1 // indirect
	github.com/pablor21/goschemagen v0.0.0 // indirect
	github.com/pablor21/protoschemagen v0.0.0-00010101000000-000000000000 // indirect
